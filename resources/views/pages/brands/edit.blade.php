...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('marca.update', $marca->id) }}" method="post" enctype="multipart/form-data" charset=utf-8>
                @csrf
                <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('nombre') is-invalid @enderror"
                                        name="nombre" id="nombre" value="{{ old('nombre', $marca->nombre) }}" />
                                    @error('nombre')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('clave') is-invalid @enderror"
                                        value="{{ old('clave', $marca->clave) }}" name="clave" id="clave"
                                        placeholder="" />
                                    @error('clave')
                                        <span class="invalid-feedback" role="alert">
                                            <strong strong>{{ $message }}</strong>
